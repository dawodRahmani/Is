...
<div class="container mt-5">
    ...
    <form id="encryptionForm" method="post" action="des.php">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="keyInput" name="key" placeholder="Enter encryption/decryption key" >
        </div>
...
// Define the API URL
$apiUrl = 'http://127.0.0.1:5000/encrypt1';
